...
export default function Contact() {
  ...
  const contactDetails = [
    ...
    { label: "Phone", value: "+91 96259 28495", href: "tel:+919625928495" },
    { label: "Hours", value: "Mon – Sun, 9:00 AM – 8:00 PM" },
    { label: "Service Area", value: "Wave City, Ghaziabad & surrounding areas" },
    { label: "WhatsApp", value: "Chat on WhatsApp", href: "https://wa.me/919625928495" },
  ];
          ...
          <div className="contact-main-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px" }}>
            ...
            <div>
              <h3 style={{
                ...
                Call, WhatsApp or Visit
              </h3>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.35)", marginBottom: "28px", lineHeight: "1.6" }}>
                For salon visits, please call or WhatsApp us to schedule — no online booking required for walk-ins.
              </p>
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                <a href="https://wa.me/919625928495" target="_blank" className="whatsapp-cta">
                ...
                <a href="https://www.instagram.com/bellaandguy_" target="_blank" rel="noopener noreferrer" className="whatsapp-cta" style={{ background: "linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)", color: "#fff" }}>
